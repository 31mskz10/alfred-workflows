...
| [Execute ImageOptim](https://github.com/31mskz10/Alfred_Workflows/releases/download/Execute_ImageOptim/Execute.ImageOptim.alfredworkflow) | 選択中のフォルダ内の画像をImageOptimで圧縮する。 |
| [Launch Applications](https://github.com/31mskz10/Alfred_Workflows/releases/download/Launch_Applications/Launch.Applications.alfredworkflow) | あらかじめ設定した複数のアプリケーションを一括起動する。 |
